...
int get_right_index(off_t);
int spaceok(off_t);
off_t to_left_key_rot(off_t, record, off_t, int);
off_t to_right_key_rot(off_t, record, off_t, int);
off_t insert_keyrotation(off_t, record);

void print_tree(off_t);
